includes := "-I quickjs_guest/include/include -I quickjs_guest/include/libc/musl/include -I quickjs_guest/include/libc/musl/arch/x86_64/ -I quickjs_guest/include/printf -I quickjs_guest/include -l hyperlight_guest_capi -L quickjs_guest/libs/release  -I quickjs-2024-01-13"
...
build:
    clang {{includes}} {{files}} -DCONFIG_VERSION=\"2024-01-13\" -D_GNU_SOURCE -DCONFIG_BIGNUM -nostdinc -nostdlib -pie -H --target=x86_64-unknown-linux-none -Wl,-entry,entrypoint
